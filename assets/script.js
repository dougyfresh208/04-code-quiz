document.addEventListener('DOMContentLoaded', function () {
    const questions = [
        ...
        },
        {
            ...
            options: ["Justin Bieber", "Nick Lachey", "Shawn Stockman", "Justin Timberlake"],
    ...
    function restartQuiz() {
        ...
        const existingRestartQuizButton = document.getElementById('restart-quiz-button');
        if (existingRestartQuizButton) {
